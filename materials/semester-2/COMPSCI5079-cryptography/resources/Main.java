 ...
 * Plaintext/Ciphertext Input: 64-bit data block in Hex
 * Key: 64-bit data --> will be trimmed into 56-bit key in Hex
...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        String text_Hex = Utils.toHex(text);
        
        System.out.println("text to Hex: " + text_Hex);
        String st = new String(Utils.hexStringToByteArray(text_Hex), StandardCharsets.UTF_8);
        System.out.println("Hex back to text: " + st);
