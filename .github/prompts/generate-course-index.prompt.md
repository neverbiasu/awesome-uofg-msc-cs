...
5.  **Use Absolute Paths**:
    *   The `href` attribute for each `<Card>` **must** be an absolute path from the root of the website.
    *   **Correct format**: `href="/notes/semester-1/<course-code>/<topic-slug>"`
    *   **Incorrect format**: `href="./<topic-slug>"`
