...
## 自检清单（实践）
- [ ] 能从零创建仓库并推送到 GitHub（SSH）。
- [ ] 能在功能分支上完成修改并合并回 `main`。
- [ ] 按规范撰写提交信息，并配置 `.gitignore`。
- [ ] 能独立解决一次简单合并冲突。

---

## 参考材料 / 内容依据
- 课程讲义：Using_Git_and_GitHub.pptx  
  `../../../../materials/semester-1/COMPSCI4084-programming-systems/lectures/Using_Git_and_GitHub.pptx`
- 实践材料：Git_and_GitHub_-_Practical_Exercises.md（或 .docx）  
  `../../../../materials/semester-1/COMPSCI4084-programming-systems/resources/Git_and_GitHub_-_Practical_Exercises.md`
